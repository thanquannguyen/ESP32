...
static void mqtt_event_handler(void *handler_args, esp_event_base_t base, int event_id, void *event_data)
{
    ...
    case MQTT_EVENT_CONNECTED:
        ...
        msg_id = esp_mqtt_client_publish(client, "/topic/qos1", result, 0, 1, 0);
...
static void mqtt_app_start(void)
{
    esp_mqtt_client_config_t mqtt_cfg = {
        .broker.address.uri = "mqtt://uxsHcfkWpHxGT9BhPOvtxZqDhJE8HsH2NZzQ4KAjfVOWVd1ARmRca7DhF7ecnL41:@mqtt.flespi.io",
    };
    ...
    case ESP_GATTS_WRITE_EVT:
        if (!param->write.is_prep)
        {
            ...
            if (gatt_db_handle_table[IDX_CHAR_VAL_A] == param->write.handle)
            {
                ...
                memcpy(&write_data[pos], param->write.value, param->write.len);
                pos += sizeof(param->write.value);
                write_data[pos++] = '\n';
